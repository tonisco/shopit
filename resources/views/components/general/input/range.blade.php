...
maxTrigger()">
    <div>
        ...
        <div class="relative z-10 h-2">
            <div class="absolute top-0 bottom-0 left-0 right-0 z-10 bg-brandLight rounded-md"></div>
    ...
    <div class="flex justify-between w-full mt-5">
        <input type="text" maxlength="6" x-on:input="minTrigger" x-model.number="minPrice"
            class="w-[72px] text-sm rounded-lg focus:outline-none border-brandLight focus:border-brandRed focus:ring-brandRed"
