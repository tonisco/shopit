...
<div data-te-modal-init class="fixed left-0 top-0 z-[1055] hidden h-full w-full overflow-hidden outline-none"
    ...
    <div data-te-modal-dialog-ref
        ...
        <div
            ...
            <button type="button"
                class="box-content self-end p-1 bg-red-500 border-none rounded-lg dark:bg-red-700 hover:no-underline hover:opacity-75 focus:opacity-100 focus:shadow-none focus:outline-none"
