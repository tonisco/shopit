...
<div class="static" data-te-nav-item-ref data-te-dropdown-ref>
    <a class="items-center hidden p-2 mr-6 text-gray-200 transition duration-150 ease-in-out bg-brandRed cursor-pointer dark:bg-brandRedDark lg:flex whitespace-nowrap hover:text-gray-300 dark:hover:text-gray-100 focus:text-gray-300 dark:focus:text-gray-100"
