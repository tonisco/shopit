<x-vendor.layout.main page="Products create">
    ...
    <section class="flex flex-col flex-1 gap-6 px-6 py-8 overflow-x-hidden">
        ...
        <form class="flex flex-col gap-8 p-8 bg-white shadow-lg rounded-2xl dark:bg-gray-800">
            ...
            <div x-data="{ val: {{ json_encode($brands) }} }">
                <select data-te-select-init data-te-select-size="lg" name="brand" id="brand">
                    <option>Select</option>
                    <template x-for="subCategory in val">
                        <option :value="subCategory.id" x-text="subCategory.name"></option>
                    </template>
                </select>
            ...
            <div class="relative" data-te-input-wrapper-init>
                <input class="form-input peer" value="{{ old('price') }}" placeholder="Price $" type="number"
                    name="price" id="price">
            ...
            <div class="relative" data-te-input-wrapper-init>
                <input class="form-input peer" value="{{ old('quantity') }}" type="number" name="quantity"
                    id="quantity">
                <label class="form-label" for="quantity">Stock Quantity</label>
            </div>

            <div class="relative" data-te-input-wrapper-init>
                <input class="form-input peer" value="{{ old('short_description') }}" type="text"
