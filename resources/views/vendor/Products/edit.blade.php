<x-vendor.layout.main page="Products edit">
    <section class="flex flex-col flex-1 gap-6 px-6 py-8 overflow-x-hidden">
        ...
        <form method="POST" enctype="multipart/form-data" action="{{ route('vendor.products.update', $product->id) }}"
                        ...
                        <select required data-te-select-init data-te-select-size="lg" name="sub-category"
                            ...
                            <template x-for="subCategory in subCategories">
                                <option :selected="subCategory.id == {{ $product->sub_category_id }}"
                                    :value="subCategory.id" x-text="subCategory.name"></option>
                            </template>
                        </select>
            ...
            <div class="flex flex-col w-full gap-2">
                <div class="relative" data-te-input-wrapper-init>
                    <input required class="form-input peer" value="{{ $product->price }}" placeholder="Price $"
            ...
            <div class="flex flex-col w-full gap-2">
                <div class="relative" data-te-input-wrapper-init>
                    <input class="form-input peer" value="{{ $product->discount }}" type="number" name="discount"
                        id="discount">
            ...
            <div class="flex flex-col w-full gap-2">
                <div class="relative" data-te-input-wrapper-init>
                    <input required class="form-input peer" value="{{ $product->qty }}" type="number" name="qty"
                        id="qty">
            ...
            <div class="flex flex-col w-full gap-2">
                <div class="relative" data-te-input-wrapper-init>
                    <input required class="form-input peer" value="{{ $product->short_description }}" type="text"
            ...
            <div class="flex flex-col w-full gap-2">
                <div class="relative" data-te-input-wrapper-init>
                    <textarea class="form-input peer" value="{{ $product->long_description }}" name="long_description"
                        id="long_description" cols="30" rows="10"></textarea>
            ...
            <div class="mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem]">
                <input
                    ...
                    type="checkbox" name="status" id="status" @if ($product->status) checked @endif />
