...
<nav class="flex-no-wrap relative flex w-full items-center justify-between bg-red-500 py-2 shadow-md shadow-black/5 dark:bg-neutral-600 dark:shadow-black/10 lg:flex-wrap lg:justify-start lg:py-4"
    data-te-navbar-ref>
    <div class="flex w-full flex-wrap items-center justify-between mx-auto px-3 2xl:px-0 max-w-7xl">
        ...
        <button
            ...
            <x-feathericon-menu class="h-7 w-7" />
        </button>
        ...
        <div class="!visible hidden flex-grow basis-[100%] items-center lg:!flex lg:basis-auto"
            ...
            <ul class="list-style-none mr-auto flex flex-col pl-0 lg:flex-row" data-te-navbar-nav-ref>
                <li class="mb-4 lg:mb-0 lg:pr-2" data-te-nav-item-ref>
                    ...
                    <a class="text-gray-900 transition duration-200 hover:text-neutral-700 hover:ease-in-out focus:text-neutral-700 disabled:text-black/30 motion-reduce:transition-none dark:text-neutral-200 dark:hover:text-neutral-300 dark:focus:text-neutral-300 lg:px-2 [&.active]:text-black/90 dark:[&.active]:text-zinc-400"
                        href="{{ route('home') }}" data-te-nav-link-ref>Home</a>
                </li>
